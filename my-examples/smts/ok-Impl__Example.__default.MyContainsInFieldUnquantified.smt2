...
(assert  (and (and (and (and (= (type $_Frame@0) (MapType4Type refType boolType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type |v'#0|) DatatypeTypeType)) (= (type |x#0@@6|) BoxType)) (= (type |v#0@@9|) DatatypeTypeType)))
(push 1)
(set-info :boogie-vc-id Impl$$Example.__default.MyContainsInFieldUnquantified)
(set-option :timeout 0)
(set-option :rlimit 16350000)
(assert (not
 (=> (= (ControlFlow 0 0) 58103) (let ((anon0_correct  (=> (and (= $_Frame@0 (|lambda#4| null $Heap alloc false)) (= (ControlFlow 0 36367) (- 0 58250))) (not (Example.__default.MyVariablesContains |v'#0| |x#0@@6|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is |v#0@@9| Tclass.Example.Variables) ($IsAlloc |v#0@@9| Tclass.Example.Variables $Heap)) (|$IsA#Example.Variables| |v#0@@9|)) (=> (and (and (and (and ($Is |v'#0| Tclass.Example.Variables) ($IsAlloc |v'#0| Tclass.Example.Variables $Heap)) (|$IsA#Example.Variables| |v'#0|)) (and ($IsBox |x#0@@6| |#$Value|) ($IsAllocBox |x#0@@6| |#$Value| $Heap))) (and (and (= 3 $FunctionContextHeight) (|Set#Equal| (Example.Variables.f |v#0@@9|) (Example.Variables.f |v'#0|))) (and (not (Example.__default.MyVariablesContains |v#0@@9| |x#0@@6|)) (= (ControlFlow 0 58103) 36367)))) anon0_correct)))))
