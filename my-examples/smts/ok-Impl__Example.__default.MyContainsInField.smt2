...
(declare-fun |v'#0| () T@U)
(declare-fun |v#0@@9| () T@U)
(declare-fun |x#4@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun $_Frame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(assert  (and (and (and (and (= (type |v'#0|) DatatypeTypeType) (= (type |v#0@@9|) DatatypeTypeType)) (= (type |x#4@0|) BoxType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type $_Frame@0) (MapType4Type refType boolType))))
(push 1)
(set-info :boogie-vc-id Impl$$Example.__default.MyContainsInField)
(set-option :timeout 0)
(set-option :rlimit 16350000)
(assert (not
 (=> (= (ControlFlow 0 0) 57654) (let ((anon2_correct  (=> (forall ((|x#5| T@U) ) (!  (=> (and (= (type |x#5|) BoxType) ($IsBox |x#5| |#$Value|)) (and (|Example.__default.MyVariablesContains#canCall| |v#0@@9| |x#5|) (|Example.__default.MyVariablesContains#canCall| |v'#0| |x#5|)))
 :qid |exampledfy.58:23|
 :skolemid |945|
 :pattern ( (Example.__default.MyVariablesContains |v'#0| |x#5|))
 :pattern ( (Example.__default.MyVariablesContains |v#0@@9| |x#5|))
)) (and (=> (= (ControlFlow 0 35971) (- 0 57968)) (forall ((|x#5@@0| T@U) ) (!  (=> (and (= (type |x#5@@0|) BoxType) ($IsBox |x#5@@0| |#$Value|)) (= (Example.__default.MyVariablesContains |v#0@@9| |x#5@@0|) (Example.__default.MyVariablesContains |v'#0| |x#5@@0|)))
 :qid |exampledfy.58:23|
 :skolemid |947|
 :pattern ( (Example.__default.MyVariablesContains |v'#0| |x#5@@0|))
 :pattern ( (Example.__default.MyVariablesContains |v#0@@9| |x#5@@0|))
))) (=> (forall ((|x#5@@1| T@U) ) (!  (=> (and (= (type |x#5@@1|) BoxType) ($IsBox |x#5@@1| |#$Value|)) (= (Example.__default.MyVariablesContains |v#0@@9| |x#5@@1|) (Example.__default.MyVariablesContains |v'#0| |x#5@@1|)))
 :qid |exampledfy.58:23|
 :skolemid |947|
 :pattern ( (Example.__default.MyVariablesContains |v'#0| |x#5@@1|))
 :pattern ( (Example.__default.MyVariablesContains |v#0@@9| |x#5@@1|))
)) (=> (= (ControlFlow 0 35971) (- 0 58008)) (not (exists ((|x#3| T@U) ) (!  (and (= (type |x#3|) BoxType) (and ($IsBox |x#3| |#$Value|) (Example.__default.MyVariablesContains |v'#0| |x#3|)))
 :qid |exampledfy.55:25|
 :skolemid |944|
 :pattern ( (Example.__default.MyVariablesContains |v'#0| |x#3|))
)))))))))
(let ((anon3_Else_correct  (=> (and (not (and ($IsBox |x#4@0| |#$Value|) ($IsAllocBox |x#4@0| |#$Value| $Heap))) (= (ControlFlow 0 35969) 35971)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and (and (and ($IsBox |x#4@0| |#$Value|) ($IsAllocBox |x#4@0| |#$Value| $Heap)) ($IsAlloc |v#0@@9| Tclass.Example.Variables $Heap)) (and ($IsAllocBox |x#4@0| |#$Value| $Heap) (|Example.__default.MyVariablesContains#canCall| |v#0@@9| |x#4@0|))) (and (and ($IsAlloc |v'#0| Tclass.Example.Variables $Heap) ($IsAllocBox |x#4@0| |#$Value| $Heap)) (and (|Example.__default.MyVariablesContains#canCall| |v'#0| |x#4@0|) (= (ControlFlow 0 35967) 35971)))) anon2_correct)))
(let ((anon0_correct  (=> (= $_Frame@0 (|lambda#3| null $Heap alloc false)) (and (=> (= (ControlFlow 0 35965) 35967) anon3_Then_correct) (=> (= (ControlFlow 0 35965) 35969) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is |v#0@@9| Tclass.Example.Variables) ($IsAlloc |v#0@@9| Tclass.Example.Variables $Heap)) (|$IsA#Example.Variables| |v#0@@9|)) (=> (and (and (and ($Is |v'#0| Tclass.Example.Variables) ($IsAlloc |v'#0| Tclass.Example.Variables $Heap)) (|$IsA#Example.Variables| |v'#0|)) (and (and (= 2 $FunctionContextHeight) (|Set#Equal| (Example.Variables.f |v#0@@9|) (Example.Variables.f |v'#0|))) (and (not (exists ((|x#1| T@U) ) (!  (and (= (type |x#1|) BoxType) (and ($IsBox |x#1| |#$Value|) (Example.__default.MyVariablesContains |v#0@@9| |x#1|)))
 :qid |exampledfy.54:26|
 :skolemid |941|
 :pattern ( (Example.__default.MyVariablesContains |v#0@@9| |x#1|))
))) (= (ControlFlow 0 57654) 35965)))) anon0_correct)))))
