...
(assert  (and (and (and (and (and (= (type |s2#0|) (MapType0Type BoxType boolType)) (= (type |s#0@0|) (MapType0Type BoxType boolType))) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type |w#0@0|) BoxType)) (= (type $_Frame@0) (MapType4Type refType boolType))) (= (type |s1#0|) (MapType0Type BoxType boolType))))
(push 1)
(set-info :boogie-vc-id Impl$$Example.__default.EqualSets2)
(set-option :timeout 0)
(set-option :rlimit 16350000)
(assert (not
 (=> (= (ControlFlow 0 0) 57107) (let ((anon2_correct  (=> (forall ((|s#1| T@U) (|w#1| T@U) ) (!  (=> (and (and (= (type |s#1|) (MapType0Type BoxType boolType)) (= (type |w#1|) BoxType)) (and ($Is |s#1| (TSet |#$Value|)) ($IsBox |w#1| |#$Value|))) (|Example.__default.MySetContains#canCall| |s#1| |w#1|))
 :qid |exampledfy.38:23|
 :skolemid |925|
 :pattern ( (MapType0Select |s#1| |w#1|))
 :pattern ( (Example.__default.MySetContains |s#1| |w#1|))
)) (and (=> (= (ControlFlow 0 34821) (- 0 57500)) (forall ((|s#1@@0| T@U) (|w#1@@0| T@U) ) (!  (=> (and (and (= (type |s#1@@0|) (MapType0Type BoxType boolType)) (= (type |w#1@@0|) BoxType)) (and ($Is |s#1@@0| (TSet |#$Value|)) ($IsBox |w#1@@0| |#$Value|))) (= (Example.__default.MySetContains |s#1@@0| |w#1@@0|) (U_2_bool (MapType0Select |s#1@@0| |w#1@@0|))))
 :qid |exampledfy.38:23|
 :skolemid |927|
 :pattern ( (MapType0Select |s#1@@0| |w#1@@0|))
 :pattern ( (Example.__default.MySetContains |s#1@@0| |w#1@@0|))
))) (=> (forall ((|s#1@@1| T@U) (|w#1@@1| T@U) ) (!  (=> (and (and (= (type |s#1@@1|) (MapType0Type BoxType boolType)) (= (type |w#1@@1|) BoxType)) (and ($Is |s#1@@1| (TSet |#$Value|)) ($IsBox |w#1@@1| |#$Value|))) (= (Example.__default.MySetContains |s#1@@1| |w#1@@1|) (U_2_bool (MapType0Select |s#1@@1| |w#1@@1|))))
 :qid |exampledfy.38:23|
 :skolemid |927|
 :pattern ( (MapType0Select |s#1@@1| |w#1@@1|))
 :pattern ( (Example.__default.MySetContains |s#1@@1| |w#1@@1|))
)) (=> (= (ControlFlow 0 34821) (- 0 57550)) (not (exists ((|z#1| T@U) ) (!  (and (= (type |z#1|) BoxType) (and ($IsBox |z#1| |#$Value|) (U_2_bool (MapType0Select |s2#0| |z#1|))))
 :qid |exampledfy.32:21|
 :skolemid |924|
 :pattern ( (MapType0Select |s2#0| |z#1|))
)))))))))
(let ((anon3_Else_correct  (=> (and (not (and (and ($Is |s#0@0| (TSet |#$Value|)) ($IsAlloc |s#0@0| (TSet |#$Value|) $Heap)) (and ($IsBox |w#0@0| |#$Value|) ($IsAllocBox |w#0@0| |#$Value| $Heap)))) (= (ControlFlow 0 34819) 34821)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and (and ($Is |s#0@0| (TSet |#$Value|)) ($IsAlloc |s#0@0| (TSet |#$Value|) $Heap)) (and ($IsBox |w#0@0| |#$Value|) ($IsAllocBox |w#0@0| |#$Value| $Heap))) (and (and ($IsAlloc |s#0@0| (TSet |#$Value|) $Heap) ($IsAllocBox |w#0@0| |#$Value| $Heap)) (and (|Example.__default.MySetContains#canCall| |s#0@0| |w#0@0|) (= (ControlFlow 0 34817) 34821)))) anon2_correct)))
(let ((anon0_correct  (=> (= $_Frame@0 (|lambda#2| null $Heap alloc false)) (and (=> (= (ControlFlow 0 34815) (- 0 57352)) (|Set#Equal| |s1#0| |s2#0|)) (=> (|Set#Equal| |s1#0| |s2#0|) (and (=> (= (ControlFlow 0 34815) 34817) anon3_Then_correct) (=> (= (ControlFlow 0 34815) 34819) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is |s1#0| (TSet |#$Value|)) ($IsAlloc |s1#0| (TSet |#$Value|) $Heap)) (and ($Is |s2#0| (TSet |#$Value|)) ($IsAlloc |s2#0| (TSet |#$Value|) $Heap))) (and (and (= 6 $FunctionContextHeight) (forall ((|x#1| T@U) ) (!  (=> (and (= (type |x#1|) BoxType) ($IsBox |x#1| |#$Value|)) (= (U_2_bool (MapType0Select |s1#0| |x#1|)) (U_2_bool (MapType0Select |s2#0| |x#1|))))
 :qid |exampledfy.30:21|
 :skolemid |920|
 :pattern ( (MapType0Select |s2#0| |x#1|))
 :pattern ( (MapType0Select |s1#0| |x#1|))
))) (and (not (exists ((|y#1| T@U) ) (!  (and (= (type |y#1|) BoxType) (and ($IsBox |y#1| |#$Value|) (Example.__default.MySetContains |s1#0| |y#1|)))
 :qid |exampledfy.31:22|
 :skolemid |922|
 :pattern ( (Example.__default.MySetContains |s1#0| |y#1|))
))) (= (ControlFlow 0 57107) 34815)))) anon0_correct))))
