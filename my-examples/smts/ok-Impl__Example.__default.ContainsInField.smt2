...
(push 1)
(set-info :boogie-vc-id Impl$$Example.__default.ContainsInField)
(set-option :timeout 0)
(set-option :rlimit 16350000)
(assert (not
 (=> (= (ControlFlow 0 0) 58313) (let ((anon0_correct  (=> (and (= $_Frame@0 (|lambda#5| null $Heap alloc false)) (= (ControlFlow 0 36923) (- 0 58510))) (not (exists ((|x#3| T@U) ) (!  (and (= (type |x#3|) BoxType) (and ($IsBox |x#3| |#$Value|) (U_2_bool (MapType0Select (Example.Variables.f |v'#0|) |x#3|))))
 :qid |exampledfy.77:25|
 :skolemid |957|
 :pattern ( (MapType0Select (Example.Variables.f |v'#0|) |x#3|))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is |v#0@@9| Tclass.Example.Variables) ($IsAlloc |v#0@@9| Tclass.Example.Variables $Heap)) (|$IsA#Example.Variables| |v#0@@9|)) (=> (and (and (and ($Is |v'#0| Tclass.Example.Variables) ($IsAlloc |v'#0| Tclass.Example.Variables $Heap)) (|$IsA#Example.Variables| |v'#0|)) (and (and (= 4 $FunctionContextHeight) (|Set#Equal| (Example.Variables.f |v#0@@9|) (Example.Variables.f |v'#0|))) (and (not (exists ((|x#1| T@U) ) (!  (and (= (type |x#1|) BoxType) (and ($IsBox |x#1| |#$Value|) (U_2_bool (MapType0Select (Example.Variables.f |v#0@@9|) |x#1|))))
 :qid |exampledfy.76:26|
 :skolemid |955|
 :pattern ( (MapType0Select (Example.Variables.f |v#0@@9|) |x#1|))
))) (= (ControlFlow 0 58313) 36923)))) anon0_correct)))))
