...
(assert  (and (and (and (= (type $_Frame@0) (MapType4Type refType boolType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type |v'#0|) DatatypeTypeType)) (= (type |v#0@@9|) DatatypeTypeType)))
(push 1)
(set-info :boogie-vc-id Impl$$Example.__default.MyContainsInField)
(set-option :timeout 0)
(set-option :rlimit 16350000)
(assert (not
 (=> (= (ControlFlow 0 0) 57261) (let ((anon0_correct  (=> (and (= $_Frame@0 (|lambda#3| null $Heap alloc false)) (= (ControlFlow 0 35740) (- 0 57446))) (not (exists ((|x#3| T@U) ) (!  (and (= (type |x#3|) BoxType) (and ($IsBox |x#3| |#$Value|) (Example.__default.MyVariablesContains |v'#0| |x#3|)))
...
))) (= (ControlFlow 0 57261) 35740)))) anon0_correct)))))
PreconditionGeneratedEntry_correct)))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 57261)))
(get-value ((ControlFlow 0 35740)))
(assert (not (= (ControlFlow 0 35740) (- 57446))))
(check-sat)
(pop 1)
; Invalid
(reset)
