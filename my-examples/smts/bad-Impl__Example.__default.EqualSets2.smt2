...
(assert (not
 (=> (= (ControlFlow 0 0) 56722) (let ((anon2_correct  (=> (forall ((|s#1| T@U) (|w#1| T@U) ) (!  (=> (and (and (= (type |s#1|) (MapType0Type BoxType boolType)) (= (type |w#1|) BoxType)) (and ($Is |s#1| (TSet |#$Value|)) ($IsBox |w#1| |#$Value|))) (|Example.__default.MySetContains#canCall| |s#1| |w#1|))
 :qid |exampledfy.38:23|
 :skolemid |925|
 :pattern ( (MapType0Select |s#1| |w#1|))
 :pattern ( (Example.__default.MySetContains |s#1| |w#1|))
)) (and (=> (= (ControlFlow 0 34777) (- 0 57107)) (forall ((|s#1@@0| T@U) (|w#1@@0| T@U) ) (!  (=> (and (and (= (type |s#1@@0|) (MapType0Type BoxType boolType)) (= (type |w#1@@0|) BoxType)) (and ($Is |s#1@@0| (TSet |#$Value|)) ($IsBox |w#1@@0| |#$Value|))) (= (Example.__default.MySetContains |s#1@@0| |w#1@@0|) (U_2_bool (MapType0Select |s#1@@0| |w#1@@0|))))
 :qid |exampledfy.38:23|
 :skolemid |927|
...
)) (=> (= (ControlFlow 0 34777) (- 0 57157)) (not (exists ((|z#1| T@U) ) (!  (and (= (type |z#1|) BoxType) (and ($IsBox |z#1| |#$Value|) (U_2_bool (MapType0Select |s2#0| |z#1|))))
 :qid |exampledfy.32:21|
 :skolemid |924|
 :pattern ( (MapType0Select |s2#0| |z#1|))
)))))))))
(let ((anon3_Else_correct  (=> (and (not (and (and ($Is |s#0@0| (TSet |#$Value|)) ($IsAlloc |s#0@0| (TSet |#$Value|) $Heap)) (and ($IsBox |w#0@0| |#$Value|) ($IsAllocBox |w#0@0| |#$Value| $Heap)))) (= (ControlFlow 0 34775) 34777)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and (and ($Is |s#0@0| (TSet |#$Value|)) ($IsAlloc |s#0@0| (TSet |#$Value|) $Heap)) (and ($IsBox |w#0@0| |#$Value|) ($IsAllocBox |w#0@0| |#$Value| $Heap))) (and (and ($IsAlloc |s#0@0| (TSet |#$Value|) $Heap) ($IsAllocBox |w#0@0| |#$Value| $Heap)) (and (|Example.__default.MySetContains#canCall| |s#0@0| |w#0@0|) (= (ControlFlow 0 34773) 34777)))) anon2_correct)))
(let ((anon0_correct  (=> (= $_Frame@0 (|lambda#2| null $Heap alloc false)) (and (=> (= (ControlFlow 0 34771) 34773) anon3_Then_correct) (=> (= (ControlFlow 0 34771) 34775) anon3_Else_correct)))))
...
))) (= (ControlFlow 0 56722) 34771)))) anon0_correct))))
