...
(assert  (and (and (and (and (= (type $_Frame@0) (MapType4Type refType boolType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type |s1#0|) (MapType0Type BoxType boolType))) (= (type |s2#0|) (MapType0Type BoxType boolType))) (= (type |s3#0|) (MapType0Type BoxType boolType))))
(push 1)
(set-info :boogie-vc-id Impl$$Example.__default.EqualSets)
(set-option :timeout 0)
(set-option :rlimit 16350000)
(assert (not
 (=> (= (ControlFlow 0 0) 56811) (let ((anon0_correct  (=> (= $_Frame@0 (|lambda#1| null $Heap alloc false)) (and (=> (= (ControlFlow 0 33835) (- 0 57016)) (|Set#Equal| |s1#0| |s2#0|)) (=> (|Set#Equal| |s1#0| |s2#0|) (=> (= (ControlFlow 0 33835) (- 0 57022)) (= (U_2_bool (MapType0Select |s3#0| ($Box |s1#0|))) (U_2_bool (MapType0Select |s3#0| ($Box |s2#0|))))))))))
...
)) (= (ControlFlow 0 56811) 33835))) anon0_correct)))))
